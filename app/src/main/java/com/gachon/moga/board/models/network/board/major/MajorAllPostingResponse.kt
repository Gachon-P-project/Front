package com.gachon.moga.board.models.network.board.major
...
data class MajorAllPostingResponse(
        ...
        @field:Json(name = "subject_name") val subjectName: String,
        @field:Json(name = "professor_name") val professorName: String,
